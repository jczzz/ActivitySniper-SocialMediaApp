        ...
        <form accept-charset="UTF-8" role="form">
            <fieldset>
              ...
              <div class="cols-sm-10">
                <div class="input-group">
                  ...
                  <input type="input" class="form-control" name="firstname"  value="<?php echo $result['firstname'] ?>"/>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="cols-sm-10">
                <div class="input-group">
                  <span class="input-group-addon"><i class="glyphicon glyphicon-user" aria-hidden="true"></i></span>
                  <input type="input"  class="form-control" name="lastname"  value="<?php echo $result['lastname'] ?>"/>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="cols-sm-10">
                <div class="input-group">
                  ...
                  <input type="input" name="email"  class="form-control" value="<?php echo $result['email'] ?>"/>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="cols-sm-10">
                <div class="input-group">
                  ...
                  <input type="input" name="phonenum"  class="form-control" value="<?php echo $result['phonenum'] ?>"/>
                </div>
              </div>
            </div>
